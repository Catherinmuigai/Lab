...
#the save funtion saves the data to the database
    ...
    die("Connection failed: " . mysqli_connect_error());
		   ...
		   $sql= mysqli_query($conne,"INSERT INTO `user`(first_name,last_name,user_city,username,password,utc_timestamp,time_zone_offset) VALUES('$fn','$ln','$city','$uname','$pass','$timestamp','$ofset')");//or die("DB Error".mysqli_connect_error());
